...
## Enables to focuse on the content when preparing your presentation
...
- A R package for building clean slides

--
  
- Control formats (via css): 
...
- Embedded codes 
  ...
  - edit data analysis for the output
...
## Name: metropolis and metropolis-fonts

- set: css: [default, metropolis, metropolis-fonts]
